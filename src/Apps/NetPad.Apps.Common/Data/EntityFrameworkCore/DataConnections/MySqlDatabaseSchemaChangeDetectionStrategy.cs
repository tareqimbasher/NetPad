...
internal class MySqlDatabaseSchemaChangeDetectionStrategy(
        ...
        IDataConnectionSchemaChangeDetectionStrategy
{
    ...
    {
        return dataConnection is MySqlDatabaseConnection;
    }

    public async Task<bool?> DidSchemaChangeAsync(DataConnection dataConnection)
    {
        if (dataConnection is not MySqlDatabaseConnection connection)
        {
            return null;
        }
    ...
    public async Task<SchemaCompareInfo?> GenerateSchemaCompareInfoAsync(DataConnection dataConnection)
    {
        ...
        return hash == null ? null : new MySqlSchemaCompareInfo(hash)
        {
