...
export interface IAppApiClient {
    ...
    getLatestVersion(signal?: AbortSignal | undefined): Promise<SemanticVersion>;
...
export class AppApiClient extends ApiClientBase implements IAppApiClient {
    ...
    getLatestVersion(signal?: AbortSignal): Promise<SemanticVersion> {
    ...
    protected processGetLatestVersion(response: Response): Promise<SemanticVersion> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = SemanticVersion.fromJS(resultData200);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<SemanticVersion>(null as any);
    }
...
export class AssemblyImage implements IAssemblyImage {
    ...
    init(_data?: any) {
        if (_data) {
            this.assemblyNameString = _data["assemblyNameString"];
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["assemblyNameString"] = this.assemblyNameString;
...
export class LinePosition implements ILinePosition {
    ...
    constructor(data?: ILinePosition) {
        ...
        if (!data) {
            this.zero = new LinePosition();
        }
    }

    init(_data?: any) {
        if (_data) {
            this.zero = _data["zero"] ? LinePosition.fromJS(_data["zero"]) : new LinePosition();
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["zero"] = this.zero ? this.zero.toJSON() : <any>undefined;
        data["line"] = this.line;
...
export class Version implements IVersion {
    ...
    defaultFormatFieldCount!: number;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.defaultFormatFieldCount = _data["defaultFormatFieldCount"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["defaultFormatFieldCount"] = this.defaultFormatFieldCount;
        return data;
    }
...
export class RequestNewScriptNameCommand extends CommandOfString implements IRequestNewScriptNameCommand {
    ...
    static override fromJS(data: any): RequestNewScriptNameCommand {
        data = typeof data === 'object' ? data : {};
