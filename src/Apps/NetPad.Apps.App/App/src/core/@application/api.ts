...
export class AppApiClient extends ApiClientBase implements IAppApiClient {
    ...
    openFolderContainingScript(scriptPath: string | null | undefined, signal?: AbortSignal): Promise<void> {
...
export class SessionApiClient extends ApiClientBase implements ISessionApiClient {
    ...
    activate(scriptId: string, signal?: AbortSignal): Promise<void> {
    ...
    activateLastActive(signal?: AbortSignal): Promise<void> {
...
export class AssemblyName implements IAssemblyName {
    ...
    rawPublicKeyToken?: string | undefined;
    rawFlags!: AssemblyNameFlags;
    ...
    init(_data?: any) {
        if (_data) {
            this.rawPublicKey = _data["rawPublicKey"];
            this.rawPublicKeyToken = _data["rawPublicKeyToken"];
            this.rawFlags = _data["rawFlags"];
            this.name = _data["name"];
            this.version = _data["version"] ? Version.fromJS(_data["version"]) : <any>undefined;
            this.cultureInfo = _data["cultureInfo"] ? CultureInfo.fromJS(_data["cultureInfo"]) : <any>undefined;
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["rawPublicKey"] = this.rawPublicKey;
        data["rawPublicKeyToken"] = this.rawPublicKeyToken;
        data["rawFlags"] = this.rawFlags;
        data["name"] = this.name;
        data["version"] = this.version ? this.version.toJSON() : <any>undefined;
        data["cultureInfo"] = this.cultureInfo ? this.cultureInfo.toJSON() : <any>undefined;
...
export class CultureInfo implements ICultureInfo {
    ...
    init(_data?: any) {
        if (_data) {
            this.parent = _data["parent"] ? CultureInfo.fromJS(_data["parent"]) : new CultureInfo();
            this.lcid = _data["lcid"];
            this.keyboardLayoutId = _data["keyboardLayoutId"];
            this.name = _data["name"];
            this.sortName = _data["sortName"];
            this.interopName = _data["interopName"];
            this.ietfLanguageTag = _data["ietfLanguageTag"];
            ...
            this.threeLetterWindowsLanguageName = _data["threeLetterWindowsLanguageName"];
            this.compareInfo = _data["compareInfo"] ? CompareInfo.fromJS(_data["compareInfo"]) : new CompareInfo();
            this.textInfo = _data["textInfo"] ? TextInfo.fromJS(_data["textInfo"]) : new TextInfo();
            this.isNeutralCulture = _data["isNeutralCulture"];
            this.cultureTypes = _data["cultureTypes"];
            this.numberFormat = _data["numberFormat"] ? NumberFormatInfo.fromJS(_data["numberFormat"]) : new NumberFormatInfo();
            this.dateTimeFormat = _data["dateTimeFormat"] ? DateTimeFormatInfo.fromJS(_data["dateTimeFormat"]) : new DateTimeFormatInfo();
            this.calendar = _data["calendar"] ? Calendar.fromJS(_data["calendar"]) : <any>undefined;
            if (Array.isArray(_data["optionalCalendars"])) {
                this.optionalCalendars = [] as any;
                for (let item of _data["optionalCalendars"])
                    this.optionalCalendars!.push(Calendar.fromJS(item));
            }
            this.useUserOverride = _data["useUserOverride"];
            this.isReadOnly = _data["isReadOnly"];
            this.hasInvariantCultureName = _data["hasInvariantCultureName"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["interopName"] = this.interopName;
        ...
        data["hasInvariantCultureName"] = this.hasInvariantCultureName;
        return data;
    }
...
export class CompareInfo implements ICompareInfo {
    ...
    init(_data?: any) {
        if (_data) {
            this.name = _data["name"];
            this.version = _data["version"] ? SortVersion.fromJS(_data["version"]) : new SortVersion();
            this.lcid = _data["lcid"];
        }
    }
...
export class TextInfo implements ITextInfo {
    ...
    init(_data?: any) {
        if (_data) {
            this.ansiCodePage = _data["ansiCodePage"];
            this.oemCodePage = _data["oemCodePage"];
            this.macCodePage = _data["macCodePage"];
            this.ebcdicCodePage = _data["ebcdicCodePage"];
            this.lcid = _data["lcid"];
            this.cultureName = _data["cultureName"];
            this.isReadOnly = _data["isReadOnly"];
...
export class NumberFormatInfo implements INumberFormatInfo {
    hasInvariantNumberSigns!: boolean;
    allowHyphenDuringParsing!: boolean;
    ...
    init(_data?: any) {
        if (_data) {
            this.hasInvariantNumberSigns = _data["hasInvariantNumberSigns"];
            this.allowHyphenDuringParsing = _data["allowHyphenDuringParsing"];
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["hasInvariantNumberSigns"] = this.hasInvariantNumberSigns;
        data["allowHyphenDuringParsing"] = this.allowHyphenDuringParsing;
...
export class DateTimeFormatInfo implements IDateTimeFormatInfo {
    ...
    calendar!: Calendar;
    eraNames!: string[];
    abbreviatedEraNames!: string[];
    abbreviatedEnglishEraNames!: string[];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.calendar = _data["calendar"] ? Calendar.fromJS(_data["calendar"]) : <any>undefined;
            if (Array.isArray(_data["eraNames"])) {
                this.eraNames = [] as any;
                for (let item of _data["eraNames"])
                    this.eraNames!.push(item);
            }
            if (Array.isArray(_data["abbreviatedEraNames"])) {
                this.abbreviatedEraNames = [] as any;
                for (let item of _data["abbreviatedEraNames"])
                    this.abbreviatedEraNames!.push(item);
            }
            if (Array.isArray(_data["abbreviatedEnglishEraNames"])) {
                this.abbreviatedEnglishEraNames = [] as any;
                for (let item of _data["abbreviatedEnglishEraNames"])
                    this.abbreviatedEnglishEraNames!.push(item);
            }
            ...
            this.rfC1123Pattern = _data["rfC1123Pattern"];
            this.shortDatePattern = _data["shortDatePattern"];
            this.shortTimePattern = _data["shortTimePattern"];
            this.sortableDateTimePattern = _data["sortableDateTimePattern"];
            this.generalShortTimePattern = _data["generalShortTimePattern"];
            this.generalLongTimePattern = _data["generalLongTimePattern"];
            this.dateTimeOffsetPattern = _data["dateTimeOffsetPattern"];
            this.timeSeparator = _data["timeSeparator"];
            this.universalSortableDateTimePattern = _data["universalSortableDateTimePattern"];
            ...
            this.hasSpacesInMonthNames = _data["hasSpacesInMonthNames"];
            this.hasSpacesInDayNames = _data["hasSpacesInDayNames"];
            this.isReadOnly = _data["isReadOnly"];
            this.nativeCalendarName = _data["nativeCalendarName"];
            ...
            this.fullTimeSpanPositivePattern = _data["fullTimeSpanPositivePattern"];
            this.fullTimeSpanNegativePattern = _data["fullTimeSpanNegativePattern"];
            this.compareInfo = _data["compareInfo"] ? CompareInfo.fromJS(_data["compareInfo"]) : new CompareInfo();
            this.formatFlags = _data["formatFlags"];
            this.hasForceTwoDigitYears = _data["hasForceTwoDigitYears"];
            this.hasYearMonthAdjustment = _data["hasYearMonthAdjustment"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["calendar"] = this.calendar ? this.calendar.toJSON() : <any>undefined;
        if (Array.isArray(this.eraNames)) {
            data["eraNames"] = [];
            for (let item of this.eraNames)
                data["eraNames"].push(item);
        }
        if (Array.isArray(this.abbreviatedEraNames)) {
            data["abbreviatedEraNames"] = [];
            for (let item of this.abbreviatedEraNames)
                data["abbreviatedEraNames"].push(item);
        }
        if (Array.isArray(this.abbreviatedEnglishEraNames)) {
            data["abbreviatedEnglishEraNames"] = [];
            for (let item of this.abbreviatedEnglishEraNames)
                data["abbreviatedEnglishEraNames"].push(item);
        }
        ...
        data["generalShortTimePattern"] = this.generalShortTimePattern;
        data["generalLongTimePattern"] = this.generalLongTimePattern;
        data["dateTimeOffsetPattern"] = this.dateTimeOffsetPattern;
        ...
        data["hasSpacesInMonthNames"] = this.hasSpacesInMonthNames;
        data["hasSpacesInDayNames"] = this.hasSpacesInDayNames;
        data["isReadOnly"] = this.isReadOnly;
        ...
        data["fullTimeSpanPositivePattern"] = this.fullTimeSpanPositivePattern;
        data["fullTimeSpanNegativePattern"] = this.fullTimeSpanNegativePattern;
        data["compareInfo"] = this.compareInfo ? this.compareInfo.toJSON() : <any>undefined;
        data["formatFlags"] = this.formatFlags;
        data["hasForceTwoDigitYears"] = this.hasForceTwoDigitYears;
        data["hasYearMonthAdjustment"] = this.hasYearMonthAdjustment;
        return data;
    }
...
export abstract class Calendar implements ICalendar {
    ...
    init(_data?: any) {
        if (_data) {
            this.minSupportedDateTime = _data["minSupportedDateTime"] ? new Date(_data["minSupportedDateTime"].toString()) : <any>undefined;
            this.maxSupportedDateTime = _data["maxSupportedDateTime"] ? new Date(_data["maxSupportedDateTime"].toString()) : <any>undefined;
            this.algorithmType = _data["algorithmType"];
            this.id = _data["id"];
            this.baseCalendarID = _data["baseCalendarID"];
            this.isReadOnly = _data["isReadOnly"];
            this.currentEraValue = _data["currentEraValue"];
            if (Array.isArray(_data["eras"])) {
                this.eras = [] as any;
                for (let item of _data["eras"])
                    this.eras!.push(item);
            }
            this.daysInYearBeforeMinSupportedYear = _data["daysInYearBeforeMinSupportedYear"];
    ...
    static fromJS(data: any): Calendar {
        data = typeof data === 'object' ? data : {};
        throw new Error("The abstract class 'Calendar' cannot be instantiated.");
    }
    ...
    toJSON(data?: any) {
        ...
        data["id"] = this.id;
        data["baseCalendarID"] = this.baseCalendarID;
        data["isReadOnly"] = this.isReadOnly;
        data["currentEraValue"] = this.currentEraValue;
        if (Array.isArray(this.eras)) {
            data["eras"] = [];
            for (let item of this.eras)
                data["eras"].push(item);
        }
        data["daysInYearBeforeMinSupportedYear"] = this.daysInYearBeforeMinSupportedYear;
...
export type CalendarId = "UNINITIALIZED_VALUE" | "GREGORIAN" | "GREGORIAN_US" | "JAPAN" | "TAIWAN" | "KOREA" | "HIJRI" | "THAI" | "HEBREW" | "GREGORIAN_ME_FRENCH" | "GREGORIAN_ARABIC" | "GREGORIAN_XLIT_ENGLISH" | "GREGORIAN_XLIT_FRENCH" | "JULIAN" | "JAPANESELUNISOLAR" | "CHINESELUNISOLAR" | "SAKA" | "LUNAR_ETO_CHN" | "LUNAR_ETO_KOR" | "LUNAR_ETO_ROKUYOU" | "KOREANLUNISOLAR" | "TAIWANLUNISOLAR" | "PERSIAN" | "UMALQURA" | "UMALQURA";

export type DayOfWeek = "Sunday" | "Monday" | "Tuesday" | "Wednesday" | "Thursday" | "Friday" | "Saturday";

export type CalendarWeekRule = "FirstDay" | "FirstFullWeek" | "FirstFourDayWeek";

export type DateTimeFormatFlags = "None" | "UseGenitiveMonth" | "UseLeapYearMonth" | "UseSpacesInMonthNames" | "UseHebrewRule" | "UseSpacesInDayNames" | "UseDigitPrefixInTokens" | "NotInitialized";
...
export type DotNetFrameworkVersion = "DotNet8" | "DotNet9";
