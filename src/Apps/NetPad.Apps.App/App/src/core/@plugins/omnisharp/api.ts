    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.additionalTextEdits)) {
            ...
            for (let item of this.additionalTextEdits)
                data["additionalTextEdits"].push(item ? item.toJSON() : <any>undefined);
        }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.spans)) {
            ...
            for (let item of this.spans)
                data["spans"].push(item ? item.toJSON() : <any>undefined);
        }
        return data;
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.quickFixes)) {
            ...
            for (let item of this.quickFixes)
                data["quickFixes"].push(item ? item.toJSON() : <any>undefined);
        }
        return data;
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.signatures)) {
            ...
            for (let item of this.signatures)
                data["signatures"].push(item ? item.toJSON() : <any>undefined);
        }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.typeParamElements)) {
            ...
            for (let item of this.typeParamElements)
                data["typeParamElements"].push(item ? item.toJSON() : <any>undefined);
        }
        if (Array.isArray(this.paramElements)) {
            data["paramElements"] = [];
            for (let item of this.paramElements)
                data["paramElements"].push(item ? item.toJSON() : <any>undefined);
        }
        ...
        if (Array.isArray(this.exception)) {
            ...
            for (let item of this.exception)
                data["exception"].push(item ? item.toJSON() : <any>undefined);
        }
        return data;
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.elements)) {
            ...
            for (let item of this.elements)
                data["elements"].push(item ? item.toJSON() : <any>undefined);
        }
        return data;
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.inlayHints)) {
            ...
            for (let item of this.inlayHints)
                data["inlayHints"].push(item ? item.toJSON() : <any>undefined);
        }
        return data;
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.textEdits)) {
            ...
            for (let item of this.textEdits)
                data["textEdits"].push(item ? item.toJSON() : <any>undefined);
        }
        data["data"] = this.data ? this.data.toJSON() : <any>undefined;
        return data;
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.codeActions)) {
            ...
            for (let item of this.codeActions)
                data["codeActions"].push(item ? item.toJSON() : <any>undefined);
        }
        return data;
    }
